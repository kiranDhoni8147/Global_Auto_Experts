...
const faqs = [
  {
    ...
    answer:
      "The pricing includes comprehensive digital diagnostics, high-quality Castrol oil, brake oil & coolant replenishment, oil filter replacement, air filter & AC filter maintenance, interior vacuuming & dashboard polishing, and exterior washing & tyre polishing.",
  },
  {
    question: "Time for Delivery",
    answer:
      "The periodic maintenance service takes a minimum of 6 hours for complete inspection, servicing, road-worthiness check, washing, billing, and processing. Repairs and replacements if any can delay the time taken for delivery (subject to the availability of parts).",
  },
  {
    question: "Repair & Replacement",
    answer:
      "Repairs and replacements are done using genuine parts certified for replacement. Our skilled technicians ensure the best service for your vehicle.",
  },
  {
    question: "Oil Grade & Quality",
    answer:
      "We use only high-quality Castrol oil for all servicing needs to ensure the best performance of your vehicle.",
  },
  {
    question: "Reliability",
    answer:
      "Our professionally trained experts provide reliable service, and you can track your service in real-time.",
  },
];
/*Testimonials*/
const testimonials = [
  ...
  },
  {
    image:
      "https://static.vecteezy.com/system/resources/previews/005/544/718/original/profile-icon-design-free-vector.jpg",
    description:
      "Wonderful Service! This was an absolute life-saver. They fixed my car in a timely and cost-effective manner. The customer service is so good too! I would recommend this to anyone.",
    name: "Sneha Kapoor",
  },
];
...
const AirCondition = () => {
  ...
  const [serviceCost] = useState(1399);
      ...
      <div className="content">
        <div className="slideshow">
          ...
          <div className="slideshow__text">
            <p>Air Condition System</p>
          </div>
        </div>
        <form style={{display: isLoading ? 'none' : 'block'}} className="customer-form" onSubmit={handleSubmit}>
      ...
      <div className="service-container">
        <div className="service-section">
          ...
          <div className="service-items">
            ...
            <div className="service-item">
              Dashboard Polish & Interior Vacuum
            </div>
